    ...
    while True:
        ...
        if ret:
            ...
            flow = cv2.calcOpticalFlowFarneback(prev_frame, next_frame, None,
                ...
                16, # window size, higher is more robust to noise but is blurrier
            ...
            # blur a little to get rid of random artifacts from the #pyramids being too small
